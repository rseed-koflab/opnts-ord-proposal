...
Finally, *Open Time Series* will be presented at a number of community events focused on research software engineering (and economic data). Existing community events such as RSE@ETH, RSECON 2024 and the RSEED at KOF meetup series have a large and intersectoral reach. From academia to administration and the private sector, the audience of these events is more diverse than that of a single event. By presenting the *Open Time Series* project at conferences or events such as these, we introduce *Open Time Series* to professionals in different fields with different open source needs and ideas for collaboration.
