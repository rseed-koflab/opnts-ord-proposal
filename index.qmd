...
iii) Machine readable data and the *Open Time Series* automation framework facilitate hosting a versioned time series database substantially;
...
The *Open Time Series* project can build on an established network for great outreach and the same time unleashes an entirely new group of publicly available, scientific use grade time series datasets. 
...
In addition to such major sources of macroeconomic data, the *Open Time Series* projects helps to make maintenance of other research use grade time series from smaller, independent providers more sustainable: 
Community maintainers can use the *Open Time Series* framework to process datasets from smaller providers with less capacity in transparent fashion that allows to eventually pass on maintenance and share workload among stakeholders.
