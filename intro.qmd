...
The folllowing sections first describe the crucial problem that the *Open Time Series* address, continue to explain how our background drives us and how our approach solves the problem. 
Our background in economic research and time series analysis combined with our experience in regular publication of reliable economic indicators helps us understand both - the perspective of a data consumer and provider. 
...
Even though machine readability of publicly available data has improved in Switzerland thanks to great efforts led by the Swiss Federal Statistical Office (FSO), researchers face a publication mindset that is focused on the wider public and hence on the most recent wave of data. 
...
The strong empirical focus of the academic research of the KOF Swiss Economic Institute at ETH (KOF) provides great synergies with the production of forecasts and indicators, many of which rely on publicly available data provided by federal and regional administrations.
...
Through our steady exchange with key data providers and data consumers such as the Swiss National Bank (SNB), the Swiss Federal Statistical Office (FSO), the Secretariat of Economic Affairs (SECO), the State Secretariat of Education, Research, and Innovation (SERI) and the cantonal statistical offices, we are aware that other institutions have often cumbersome, semi-automatic data sourcing processes to process publicly available that are highly redundant across institutions.
