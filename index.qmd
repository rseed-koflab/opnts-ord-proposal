...
In addition to such major sources of macroeconomic data, the opnts projects helps to make maintenance of other research use grade time series from smaller, independent providers more sustainable: 
...
This approach allows researchers to publicly archive data and make results reproducible more easily.
