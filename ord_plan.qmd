...
*In Work Package 1 (WP1), we lay the technical foundation for turning KOF Swiss Economic Institute's (KOF) existing production process of macroeconomic time series into an open-source framework that creates publicly available, machine-readable, scientific-grade time series in a fully reproducible fashion. 
